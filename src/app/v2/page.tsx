...
const quickActions = [
  { label: "Apply", note: "Begin enrollment", href: "/admissions" },
  { label: "Visit", note: "Schedule a tour", href: "/admissions" },
  { label: "Request Info", note: "Get our viewbook", href: "/admissions" },
];
      ...
      <section className="relative min-h-screen flex items-end">
        ...
        <div className="relative w-full max-w-7xl mx-auto px-6 pb-28 md:pb-36 pt-40">
          <div className="max-w-3xl">
            <p className="eyebrow text-white/70 animate-fade-up">
              Brighton, Colorado · Christ-Centered Since 1973
            </p>
            <h1 className="mt-5 font-serif text-[3rem] leading-[1.02] md:text-7xl font-semibold text-white animate-fade-up animation-delay-200">
              Where faith and learning grow together.
            </h1>
            <p className="mt-6 text-lg md:text-xl text-white/85 leading-relaxed max-w-2xl animate-fade-up animation-delay-400">
              A college-preparatory education rooted in Scripture and shaped by
              teachers who know your child by name—preschool through twelfth grade.
            </p>
            <div className="mt-9 flex flex-col sm:flex-row gap-4 animate-fade-up animation-delay-600">
              <Link
                href="/admissions"
